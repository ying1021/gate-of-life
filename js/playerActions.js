...
async function newLife() {
  ...
  if (result && result.玩家状态) {
    ...
    const innateInfo = {
      ...
      '马': '🐴 本能【耐力】：体力消耗-30%',
      '象': '🐘 本能【厚皮】：防御+20%',
      '熊': '🐻 本能【狂暴】：生命低于30%时攻击力+40%',
      '狐': '🦊 本能【狡黠】：交易时更易获得有利交换',
      '鼠': '🐭 本能【隐匿】：闪避+20%',
      '蛙': '🐸 本能【跳跃】：脱离战斗必定成功',
      '鳄鱼': '🐊 本能【潜伏】：水中首次攻击伤害翻倍',
      '鲨鱼': '🦈 本能【嗜血】：闻到血腥味后攻击力+25%',
      '仙人掌': '🌵 本能【储水】：饱腹值消耗-30%',
      '藤蔓': '🌿 本能【缠绕】：攻击附带束缚效果',
      '骷髅': '💀 本能【不死】：免疫中毒、窒息、冻伤',
      '幽灵': '👻 本能【虚无】：物理攻击减免50%',
    ...
    const species = playerData.species;
    if (innateInfo[species]) {
      addMessage(`💡 ${innateInfo[species]}`, 'inner');
    }
...
function showHelpPopup() {
  ...
  popupData = [
    ...
    { label: '【探索】长按：查看当前地图能探索到的资源', action: () => {} },
    ...
    { label: '【营地】点击：查看营地建筑', action: () => {} },
    { label: '【营地】长按：在商店购买物资', action: () => {} },
